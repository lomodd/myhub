...
// res.render('index', { title: 'Express to Success,Oh yeah LOL',author:'Lomodd' ,timestamp:new Date()});
// };
...
module.exports = function(app) {
    ...
    // res.render('index',{title:'test',author:'d',timestamp:''});
    // });
    
    // app.get('/',function(req,res){
        // User.get("root",function(){
            // res.render('404');
        // });
//                   
    // });
    ...
    app.get('/login', function(req, res) {
        res.render('login', {
            ...
            success : req.flash('success').toString(),
            error : req.flash('error').toString(),
            title : 'Express to Success,Oh yeah LOL',
            author : 'Lomodd',
            timestamp : new Date()
        });
    });
    ...
    app.post('/upload', function(req, res) {
        console.log('FFFFFFFFFFFFFFFF*******K!' + req.files);
    ...
    app.get('/chatroom', checkLogin);
    app.get('/chatroom',function(req,res) {
        console.log('*****************signin chatroom*****************');
    ...
    app.get('/u/:name/:day/:title', function(req, res) {
        Post.getOne(req.params.name, req.params.day, req.params.title, function(err, post) {
            if (err) {
                req.flash('error', err);
                console.log('articel page Error:'+err);
                return res.redirect('/');
            }
            res.render('article', {
